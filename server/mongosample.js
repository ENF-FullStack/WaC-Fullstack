...
client.connect(function(err) {
    if (err) console.log('Cannot connect',err);
        ...
        let authors=[
            {_id:new ObjectID().toHexString(),lastName:'Tolkien',firstName:'J.R.R'},
            {_id:new ObjectID().toHexString(),lastName:'Vonnegut',firstName:'Kurt'},
            {_id:new ObjectID().toHexString(),lastName:'Hemingway',firstName:'Ernst'}
        ];
